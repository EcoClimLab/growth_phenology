...
library(patchwork)
#SCBI ----
SCBI_weather <- read.csv("Data/climate data/SCBI/met_tower_data_sensor2_ncdc_supplemented.csv")
#spei <- read.csv("~/GitHub/Climate/Climate_Data/SPEI/data_downloaded/SCBI/spei_-78.25_38.75.csv")
spei_all_months <- read.csv("Data/climate data/CRU/spei_all_months.csv")
