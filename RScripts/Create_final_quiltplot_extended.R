...
tmx_data <- read.csv("results/tree_cores/quiltlplots/all/tmx_quilt_plot_data_EXTENDED.csv")
...
tmn_data <- read.csv("results/tree_cores/quiltlplots/all/tmn_quilt_plot_data_EXTENDED.csv")
