...
library(gridExtra)
png(filename = "doc/manuscript/tables_figures/pheno_Tsensitivity_SCBI.png", width=15, height=25,
...
grid.arrange(
  ...
  ggplot() +
    ...
    as.table = TRUE, nrow=5, ncol=2) ###as.table specifies order if multiple rows
