...
## y1: Percentage DOY climwin all wood types, all percs DAILY ----
...
## y2: Percentage DOY climwin all wood types, all percs WEEKLY ----
...
write.csv(dffinal, file = "results/Climwin_results/Weekly/SCBI/weekly_climwin_results_975perc.csv", row.names = FALSE)


## y3: Total growth DAILY ----
# rangedates <- data.frame("feb1", round(30)) #/7 for week
# rangedates2 <- data.frame("mar1", round(59)) #/7 for week
# names(rangedates) <- names(rangedates2)
# rangedates <- rbind(rangedates, rangedates2)
