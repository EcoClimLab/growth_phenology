...
for(v in climate_variables) {
  ...
  png(paste0("results/", "monthly_", "correlation", "SCBI","EXTENDED", v, ".png"), res = 150, width = 169, height = 169, units = "mm", pointsize = 10)
...
write.csv(all.dcc.output, file = "Results/scbi_core_corr_EXTENDED.csv", row.names = FALSE)
##################################################################################################
