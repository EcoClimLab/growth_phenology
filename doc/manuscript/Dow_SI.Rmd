...
**(a) $T_{max}$**
```{r climwin_rp_tmax_HARV, out.width="100%", echo=FALSE, fig.align="left", fig.cap= climwin_rp_DOY25_HARV_short_caption}
...
**(a) $T_{max}$**
```{r climwin_dp_tmin_HARV, out.width="100%", echo=FALSE, fig.align="left", fig.cap= climwin_dp_DOY25_HARV_short_caption}
