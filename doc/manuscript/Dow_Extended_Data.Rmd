...
pack_rows("Ring-porous", 1, 15, latex_gap_space = "1em", colnum = 4, hline_before = FALSE) %>%
pack_rows("Diffuse-porous", 16, 25, latex_gap_space = "1em", colnum = 4, hline_before = FALSE) %>%
row_spec(26, bold = T) %>%
kable_styling(latex_options = c("scale_down", "hold_position"), protect_latex = T) 
```
