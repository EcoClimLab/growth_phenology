...
tree_ring_summary_caption =  "Extended Data Table 3 | Summary of tree-ring data and analysis" 
...
add_header_above(c(" " = 2,  "April" = 2, "May" = 2,"June" = 2,"July" = 2,"Aug" = 2,"April" = 2,"June-July" = 2,"A:JJ" = 2)) %>%
add_header_above(c(" " = 1,  "n sig. correlations in univariate analysis" = 10,"n sig. correlations in multivariate analysis" = 6)) %>%
    #column_spec(3:18, width = ".3cm") %>%
pack_rows("Ring Porous", 1, 16, latex_gap_space = "1em", colnum = 4, hline_before = FALSE) %>%
pack_rows("Diffuse Porous", 17, 27, latex_gap_space = "1em", colnum = 4, hline_before = FALSE) %>%
row_spec(28, bold = T) %>%
kable_styling(latex_options = c("scale_down", "hold_position"), protect_latex = T) 
```
