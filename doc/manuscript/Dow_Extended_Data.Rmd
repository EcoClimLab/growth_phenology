...
sample_size_by_year_caption <- "TO BE REMOVED | Sample size by year "
...
tree_ring_summary_caption =  "Extended Data Table 3 | Summary of tree-ring data and analysis ( including species, n chronologies (= n sites), n positively correlated with April T, n sig.)" 
...
pheno_Tmax_climwin_caption <- "**Extended Data Figure 4 | Relationship between growth parameters and mean maximum temperature within the critical temperature window (CTW).** CTW was defined using *climwin*. For each observed climwin mean temperature value, the posterior mean of the fitted day of year is represented by the solid blue line and 95% credible intervals are represented by bands.(**NEEDS MORE DETAIL**)" #needs attention!!!
...
*This figure PROBABLY NEEDS TO GO. It needs some work if we choose to include it. *
...
## (PLACEHOLDER FOR `r tree_ring_summary_caption` )

\newpage

## (PLACEHOLDER FOR MAP OF STUDY SITES -- [GITHUB ISSUE #54](https://github.com/EcoClimLab/growth_phenology/issues/54))
