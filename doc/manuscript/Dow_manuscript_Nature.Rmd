...
However, model representation of C allocation to stem growth is overly simplistic in that it does not capture known decoupling of stem growth from photosynthate production[@delpierre_temperate_2016;@delpierre_wood_2016].
As a result, *the spring temperature-sensitivity of* stem growth -- or woody aboveground net primary productivity ($ANPP_{woody}$) on the ecosystem level -- may not be accurately represented in models[@delpierre_temperate_2016]. 
Given that the C allocated to woody growth typically resides in the ecosystem for decades to centuries[@xue_global_2017;@russell_residence_2014], compared to much shorter residence times of other pools such as leaves and fine roots[@refs], understanding the sensitivity of $ANPP_{woody}$ to spring temperatures is central to predicting the future of the temperate deciduous forest C sink. 
...
However, earlier initiation of growth would not necessarily translate to earlier, faster, or more stem growth; rather, cell enlargement is dependent upon environmental conditions on hourly to daily time scales[@zweifel_why_2021], and annual growth is more closely linked to conditions within the growing season than to growing season length[@etzold_number_2022], gross primary productivity[@delpierre_wood_2016], or _NEE_[@delpierre_wood_2016]. 
Furthermore, growth of broadleaf deciduous trees may be sink-saturated[@ref], such that longer growing seasons with more C fixation do not necessarily augment growth[@delpierre_wood_2016;@zani_increased_2020;@zohner_how_2021].
