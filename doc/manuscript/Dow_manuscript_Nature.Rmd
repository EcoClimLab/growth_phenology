...
Much less is known about how deciduous broadleaf tree growth responds to spring temperatures.
While close coordination of budburst and initiation of xylogenesis[@delpierre_temperate_2016] suggests that warm springs should shift the timing of growth earlier alongside leaf phenology[@jeong_phenology_2011;@keenan_net_2014;@buermann_widespread_2018;@finzi_carbon_2020;@stuble_plant_2021;@delgado_differences_2020], it has been observed that annual growth is more dependent on conditions within the growing season then on growing season length[@etzold_number_2022]. 
Furthermore, recent evidence suggests that growth of broadleaf deciduous trees may be sink-saturated, such that longer growing seasons with more C fixation do not necessarily augment growth[@refs].
...
These observations do not necessarily align with the finding that warming spring temperatures increase annual forest CO~2~ uptake in temperate deciduous forests[@keenan_net_2014].
