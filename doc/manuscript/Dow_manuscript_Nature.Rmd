...
(1) single day growth rates were $\ge 2$ standard deviations away from the mean for each xylem architecture (SCBI = 2, Harvard Forest = 34); 
...
(3) tree-years with small or negligible total growth ($\Delta DBH$ $\le 0.05$ mm; SCBI = 0, Harvard Forest = 66); 
(4) models with unexplained sharp spikes in growth rate (SCBI = 0, Harvard Forest = 3); 
and (5) poorly fit models that did not meet any of the above criteria (SCBI = 2, Harvard Forest = 0).
