...
<!--LENGTH: The typical length of an article with 3-4 modest display items (figures and tables) is 2000-2500 words (summary paragraph plus body text). We're currently at 2671 words and 1 modest + 2 large display items. Articles typically have 30-50 references (currently at 53)-->
...
Combined with observations that warming springs tend to lengthen the season of C sequestration[@lu_no_2022;@finzi_carbon_2020] and increase net C sequestration[@keeling_increased_1996;@dragoni_evidence_2011;@keenan_net_2014;@crabbe_extreme_2016;@zhou_explaining_2016;@fu_maximum_2019;@finzi_carbon_2020], our findings imply a lengthening of the period from peak stem growth to the cessation of CO~2~ uptake by the ecosystem and an increase in C allocated to functions other than stem expansion.
What happens with this extra C? 

<!--extra C is probably not going to ANPP_woody-->
Additional C fixation in years with warm springs[@keeling_increased_1996;@dragoni_evidence_2011;@keenan_net_2014;@crabbe_extreme_2016;@zhou_explaining_2016;@fu_maximum_2019;@finzi_carbon_2020] does not substantially augment stem diameter growth in the current or following year (`r EDF_tree_rings_TMAX_extended`), and is unlikely to augment $ANPP_{woody}$. 
Although $ANPP_{woody}$ is routinely calculated based on stem growth, the two can be partially decoupled through differences in wood density or C content[@delpierre_wood_2016].
It is theoretically possible that extra C is allocated to enhanced cell wall thickening, a process that lags behind stem expansion[@cuny_woody_2015], or to a higher ratio of high-density latewood to lower-density earlywood, resulting in formation of more C-dense wood in years with warm springs.
However, existing evidence indicates that warm springs have a neutral or negative effect on latewood width[<!--@tardif_influence_2006;-->@roibu_climatic_2020;@kern_multiple_2013], which is more strongly controlled by summer drought stress[<!--@tardif_influence_2006;-->@roibu_climatic_2020;@kern_multiple_2013], suggesting that a positive effect of warm springs on the total C content of annual rings is unlikely. 
Rather, the most likely explanation of the observed lack of correlation between spring temperatures and stem growth is that growth is sink-limited, such that increased GPP does not enhance $ANPP_{woody}$[@delpierre_wood_2016].

<!--on the fate of extra C-->
Our results add to a growing body of evidence for a sink limitation of stem growth[@delpierre_wood_2016;@refs], wherein global change factors known to enhance photosynthesis, such as longer growing seasons or elevated CO~2~, fail to stimulate $ANPP_{woody}$[@jiang_fate_2020;@refs].
...
Across latitudinal gradients, warmer spring temperatures are associated with earlier leaf-out[@delgado_differences_2020] and longer growing seasons, which in turn are correlated with greater tree growth[@anderson-teixeira_joint_2021], woody productivity[@banburymorgan_global_2021], and NEE[@churkina_spatial_2005]<!--Can we replace this churkina_2005 ref with another NEE ref? NO, it's making a different point.-->.<!-- The point here is that if you compare across sites in different climates (Harvard Forest and SCBI, for example), you do see greater stem growth associated with the longer growing seasons. Hopefully my rewording makes that clear. -->
...
Thus, warm springs can have a net negative effect on growth at some times or places[@gao_earlier_2022].


<!--conclusions-->
As climate change accelerates and spring temperatures become increasingly warmer, growing seasons will start earlier. 
