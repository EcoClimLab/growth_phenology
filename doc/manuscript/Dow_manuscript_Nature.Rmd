...
However, inconsistent with the concept that an earlier start to the growing season would increase annual stem growth, we demonstrate that warmer springs hasten the cessation of peak stem expansion and thereby have negligible effect on total annual stem growth for most species and locations (Fig. `r tree_rings`). 
...
This allows an asymetric fit to the data, where the onset of growth can be estimated independent of the cessation of growth.
