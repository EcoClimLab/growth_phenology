...
However, recent experimental and observational findings show that annual stem growth is not correlated with growing season length[@etzold_number_2022], but rather can be limited by sink factors[@keenan_timing_2015;@zani_increased_2020;@zohner_how_2021;@delpierre_wood_2016],<!--I (KAT) want to work on this (and check if keenan_timing_2015 looks at stem growth)--> and that positive effects of warm springs can be compensated by negative effects of accumulation of seasonal water deficits[@buermann_widespread_2018]. 
...
**However, inconsistent with the concept that an earlier start to growth would increase annual woody productivity, we demonstrate that warmer springs hasten the deceleration of stem expansion and thereby have negligible effect on total annual growth for most species and locations (Fig. 3).**
**We demonstrate that warmer springs either have little effect on, or even hasten, the deceleration of stem expansion and thereby have negligible effect on total annual stem growth for most species and locations (Fig. `r tree_rings`).** <!--repeated sentence-->
Our observations suggest that the deceleration of stem expansion (starting on $DOY_{g_{max}}$), which occurs mid-summer near the time of <!--the summer solstice and--> peak canopy greenness (`r EDF_growth_curves_all`)[@finzi_carbon_2020;@etzold_number_2022], is likely driven by cues other than photosynthate limitation, such as water stress, daylength, or sink limitation[@zweifel_why_2021;@etzold_number_2022;@zani_increased_2020;@keenan_timing_2015;@fu_variation_2014;@delpierre_wood_2016;@delpierre_temperate_2016]. <!--note that the timing of the cessation of PRIMARY shoot growth is linked to bud-set, which must be accomplished before the first frost, and has been the subject of some research (see delpierre_temperate_2016, rohde_temperature_2011), but I don't know what if any linkage exists between secondary growth and bud set.-->
...
Warm springs may also amplify summer drought stress in some times and places, effectively canceling out any positive effects of an extended growing period on annual productivity[@buermann_widespread_2018;@zhang_drought_2021]. 
