...
While responses of leaf phenology and seasonal _NEE_ to warming spring temperatures have been documented[@jeong_phenology_2011; @keenan_net_2014; @buermann_widespread_2018; @ibanez_forecasting_2010; @menzel_european_2006; @menzel_growing_1999;@finzi_carbon_2020], little is known about how the longest-lived component of fixed C in trees, the woody stem growth, is responding to warming spring temperatures. 
In fact, we are aware of only a few studies that have documented stem-growth timing of temperate deciduous trees over multiple years[@dorangeville_peak_2021; @etzold_number_2022; @tumajer_limitation_2022]. <!-- Could delete this sentence? I'm not aware of any others, but we do want to make sure we're not missing anything. klesse_integrating_2016 and martin_hydrometeorology_2017 both do this, but for conifers.-->
**However, the climate sensitivity of stem growth timing in temperate deciduous trees and its link to annual growth has seen a recent surge in interest within published literature[@dorangeville_peak_2021; @etzold_number_2022; @tumajer_limitation_2022; zweifel_why_2021]** <!-- revise this statement. Etzold et al kind of do this.-->
...
Together, our results demonstrate that warmer spring temperatures in the temperate deciduous forests of eastern North America advance the timing of stem growth but have little effect on annual ring-width (Figs. `r schematic_summary`- `r tree_rings`). 
The observed advance in stem growth under warmer springs parallels phenological advances observed for canopy foliage (Fig. `r DOY_timing`a-b)[@keenan_net_2014;@finzi_carbon_2020;@stuble_plant_2021] and _NEE_[@keenan_net_2014; @finzi_carbon_2020].
However, inconsistent with the concept that an earlier start to growth would increase annual stem growth, we demonstrate that warmer springs hasten the cessation of stem expansion and thereby have negligible effect on total annual stem growth for most species and locations (Fig. `r tree_rings`). 
Our observations suggest that the cessation of rapid stem expansion, which occurs mid-summer near the time of peak canopy greenness (`r EDF_growth_curves_all`)[@finzi_carbon_2020; @etzold_number_2022], is likely driven by cues other than photosynthate limitation, such as daylength or sink limitation, which also play an important role in autumn leaf senescence[@etzold_number_2022;@zani_increased_2020;@keenan_timing_2015;@fu_variation_2014].
...
Warm springs may also amplify summer drought stress in some times and places, effectively canceling out any positive effects of an extended growing period[@buermann_widespread_2018;@zhang_drought_2021]; however, spring temperatures and summer Standardized Precipitation Evapotranspiration Index[@vicente-serrano_multiscalar_2010] were uncorrelated within our dendrometer band analysis, implying that the effects of warm spring temperatures on stem growth elucidated here (Fig. `r schematic_summary`) were not attributable to summer drought. 

Our finding that interannual variation in stem growth is more strongly linked to conditions during the peak growing season than to growing season length aligns with recent studies on annual stem growth[@etzold_number_2022; @tumajer_limitation_2022] and with parallel findings for _NEE_[@zhou_explaining_2016; @fu_maximum_2019].
