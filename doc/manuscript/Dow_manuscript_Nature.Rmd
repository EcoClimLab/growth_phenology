...
Rather, the most likely explanation of the observed lack of correlation between spring temperatures and stem growth is that growth is sink-limited[@delpierre_wood_2016;@refs].

<!--on the fate of extra C-->
Our results add to a growing body of evidence for a sink limitation of stem growth[@delpierre_wood_2016;@refs], wherein global change factors known to enhance photosynthesis, such as longer growing seasons or elevated CO~2~, do not cause a corresponding increase in $ANPP_{woody}$[@jiang_fate_2020;@refs].
