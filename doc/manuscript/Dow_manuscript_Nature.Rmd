...
- our study adds to a growing body of literature demonstrating a sink limitation of stem growth and $ANPP_{woody}$ [@refs]. Specifically, [explain]. The implication is that while elements of global change such as warming spring temperatures or elevated CO~2~[@refs] may enhance GPP, woody growth remains constrained.
- we do not know where the extra C is going. If we look at instances where growth is more strongly limited than GPP, we see that NSCs can build up[@refs], and this build up can feed back to reduce photosynthesis[@refs]. We can also look to studies documenting enhanced GPP with no enhancement of growth. In a mature eucalypt forest exposed to elevated CO2, enhanced GPP did not result in higher growth, but rather was released back to the atmosphere on relatively short time scales through enchanced respiration[@jiang_fate_2020]
