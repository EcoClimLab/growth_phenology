...
Weather data for Harvard Forest are available through the Harvard Forest Data Archive (https://harvardforest.fas.harvard.edu/harvard-forest-data-archive) <!--specify link, version-->.
...
We used *climpact* software (see www.climpact-sci.org) <!--specify version-->.
