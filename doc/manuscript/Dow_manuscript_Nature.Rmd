...
In fact, we are aware of only two studies that have documented stem-growth phenology of temperate deciduous forests over multiple years[@dorangeville_peak_2021; @etzold_number_2022]. <!-- I'm not aware of any others, but we do want to make sure we're not missing anything. klesse_integrating_2016 and martin_hydrometeorology_2017 both do this, but for conifers.-->
