...
If extra photosynthate made available through a growing difference between GPP and $ANPP_{woody}$ is allocated to functions that relieve limitations on woody growth -- for example, by enhancing nutrient and water acquisition through enhanced allocation to roots[@zohner_how_2021] -- it is possible that warming spring temperatures could ultimately increase $ANPP_{woody}$ through indirect mechanisms.
