...
<!--LENGTH: The typical length of an article with 3-4 modest display items (figures and tables) is 2000-2500 words (summary paragraph plus body text). We're currently at 2839 words and 1 modest + 2 large display items. Articles typically have 30-50 references (currently at 53)-->
...
Although stem diameter increments are routinely used to calculate $ANPP_{woody}$, stem volume growth does not directly translate into C content, but rather can be partially decoupled through differences in wood density or C content[@delpierre_wood_2016].
