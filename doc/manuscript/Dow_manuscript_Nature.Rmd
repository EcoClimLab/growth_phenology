...
Similarly, at both sites, the stem growth milestones $DOY_{25}$, $DOY_{50}$, and $DOY_{g_{max}}$ all decreased with mean $T_{max}$ during the critical temperature window (Figs. `r schematic_summary`, `r DOY_timing`c-d; `r EDF_pheno_all`).
