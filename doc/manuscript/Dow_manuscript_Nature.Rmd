...
Although stem diameter increments are routinely used to calculate $ANPP_{woody}$[@refs], stem volume growth does not directly translate into C content, but rather can be partially decoupled through differences in wood density or C content[@delpierre_wood_2016 and refs therein].  
...
- positive effects of warm springs can be compensated by negative effects of accumulation of seasonal water deficits[@buermann_widespread_2018;@lian_summer_2022]
- our analysis isn't set up for detecting interaction. But, sites are fairly mesic. Mechanisms remain to be understood, but the net result is the same. 
