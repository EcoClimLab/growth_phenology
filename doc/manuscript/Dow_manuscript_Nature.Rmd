...
Kristina J. Anderson-Teixeira^1,9^*
...
6. Center for Geospatial Analytics; North Carolina State University; Raleigh, NC 27607, USA

7. Smithsonian Environmental Research Center, Edgewater, MD, USA

8. Canadian Forest Service, Northern Forestry Centre, Edmonton, Alberta, Canada

9. Forest Global Earth Observatory; Smithsonian Tropical Research Institute; Panama, Republic of Panama
...
The patterns observed at our focual sites were mirrored across an additional `r n_chronologies-n_chronologies_SCBI-n_chronologies_HF` chronologies from `r n_cores_sites-2` (Fig. `r tree_rings`; `r EDF_map`).
...
Rather, the primary effect of temperature on annual growth is a negative effect of $T_{max}$ during the peak growing season, which is most likely a signal of drought stress driven by increased vapor pressure deficit[**REFS**].
It is possible that an earlier start to the growing season may provide some buffer against drought later in the growing season, effectively reducing drought sensitivity, but this hypothesis remains to be evaluated.
...
Tree-ring evidence from SCBI suggests that both processes may influence the climate sensitivity of annual woody growth, and that this dynamic is likely complex[@helcoski_growing_2019].
...
A study examining long-term trends in growing season length and NEE[@keenan_net_2014] -- as opposed to their interannual variation -- showed increasing trends in both within the temperate deciduous biome, suggesting that the C that is not allocated to current year growth may have a fairly long residence time within the ecosystem; however, the amount and fate of this carbon remains unknown.
...
*Future research will be important to sortitng this out.*
...
Warm spring temperatures result in earlier leaf-out (Fig. `r DOY_timing` , REFS), an earlier start to net C sequestration[@keenan_net_2014], and, as shown here, earlier initiation of stem growth (Figs. `r schematic_summary`- `r pheno_Tsensitivity`).
Yet, an earlier start to the growing season is not associated with a longer growing season or increased growth (Figs. `r schematic_summary`- `r tree_ring`), presumably because stem diameter increases are curtailed by other factors such as...., supporting the concept of *C sink limitation* [@zani_increased_2020].
...
The timing of tree growth has profound impacts on ecosystem interactions, as well as dictates periods of highest drought sensitivity in temperate forests (Foster, 2014; D’Orangeville et al. in review). 
...
MCD12Q2 V6 Land Cover Dynamics product (informally called the MODIS Global Vegetation Phenology product) [@friedl_mcd12q2_2019]
