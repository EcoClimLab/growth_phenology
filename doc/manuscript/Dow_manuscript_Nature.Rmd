...
Of this important C sink, ~`r round(3.6/7.6,2)*100`%<!-- temperate net / global net, (Harris et al. Table 1)--> occurs in temperate forests[@harris_global_2021], with temperate deciduous forests sequestering >0.3 Gt C yr^-1^ [@pugh_role_2019]. <!-- Pugh et al. 2019 estimate that the temperate deciduous sink is >300 Tg C yr-1, with ~200 Tg C yr-1  attributable to demography (forest regrowth) and >100 Tg C yr-1  controlled by environmental drivers.--> 
