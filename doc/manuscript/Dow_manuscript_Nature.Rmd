...
Either way, our results demonstrate that warm springs do not increase $ANPP_{woody}$ on an interannual time scale.
...
- we show lack of effect on interannual scale 
- feedbacks such as greater nutrient acquisition could change this.
