...
Our results add to a growing body of evidence for a sink limitation of stem growth[@delpierre_wood_2016;@refs], wherein global change factors known to enhance photosynthesis, such as longer growing seasons or elevated CO~2~, not cause a corresponding increase in $ANPP_{woody}$[@jiang_fate_2020;@refs].
