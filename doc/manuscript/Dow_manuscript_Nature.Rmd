...
<!--LENGTH: The typical length of an article with 3-4 modest display items (figures and tables) is 2000-2500 words (summary paragraph plus body text). We're currently at 2763 words and 1 modest + 2 large display items. Articles typically have 30-50 references (currently at 53)-->
...
This analysis was performed separately for ring- <!--(67 trees at SCBI and 138 trees at Harvard Forest)-->and diffuse porous <!--(52 trees at SCBI and 183 trees at Harvard Forest)-->species (`r EDT_species`), which differ in the seasonal timing of growth[@dorangeville_peak_2021;@tumajer_limitation_2022]. 
