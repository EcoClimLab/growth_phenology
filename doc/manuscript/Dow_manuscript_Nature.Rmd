...
As global atmospheric CO~2~ concentrations increase and Earth's temperatures increase, the responses and feedbacks of forests will play an important yet uncertain role in influencing atmospheric CO~2~ and climate change[@arora_carbon_2020; @friedlingstein_global_2020]. 
...
# Created in RScripts/additional_figures.R
knitr::include_graphics("tables_figures/DOYtiming_stemgrowth+foliage.png")
```
