...
For ring- and diffuse- porous species at both sites, warmer $T_{max}$ in the CTW resulted in earlier achievement of phenological milestones.
...
Similarly, at both sites, the stem growth milestones $DOY_{25}$, $DOY_{50}$, $DOY_{75}$, and $DOY_{g_{max}}$ all decreased with mean $T_{max}$ during the critical temperature window (Figs. `r schematic_summary`, `r DOY_timing`; `r EDF_pheno_all`).
