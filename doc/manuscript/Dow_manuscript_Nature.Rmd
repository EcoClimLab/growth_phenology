...
<!--LENGTH: The typical length of an article with 3-4 modest display items (figures and tables) is 2000-2500 words (summary paragraph plus body text). We're currently at 2641 words and 1 modest + 2 large display items. Articles typically have 30-50 references (currently at 53)-->
...
The CTW was defined as the weeks for which this correlation was strongest, and mean $T_{max}$ during this period (CTW $T_{max}$) used as the independet variable.   
...
In contrast to the pronounced effects of CTW $T_{max}$ on the timing of growth, its effects on $g_{max}$ and $\Delta DBH$ were weak and inconsistent (Figs. `r schematic_summary`, `r EDF_pheno_all`). 
...
This revealed little correlation between spring temperatures and growth the following year, with significant positive correlations of RWI to March or April $T_{max}$ for 5/142 ring porous chronologies and to April or May $T_{max}$ for 7/66 diffuse porous chronologies.
...
The observed advance in stem growth under warmer springs parallels phenological advances observed for canopy foliage (Fig. `r DOY_timing`a-b)[@keenan_net_2014;@finzi_carbon_2020;@stuble_plant_2021] and NEE[@keenan_net_2014;@finzi_carbon_2020]. 
