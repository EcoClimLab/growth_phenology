...
Combined with observations that warming springs tend to lengthen the season of C sequestration[@refs], our observations imply a lengthening of the period from peak stem growth to the cessation of CO~2~ uptake by the ecosystem.
What happens with the extra C fixed during this period? 

<!--extra C is probably not going to ANPP_woody-->
Additional C fixed in years with warm springs does not substantially augment stem diameter growth in the current or following year (`r EDF_tree_rings_TMAX_extended`), and is unlikely to augment $ANPP_{woody}$, which, although routinely calculated based on stem growth, can be partially decoupled from it through differences in wood density or C content[@delpierre_wood_2016].
