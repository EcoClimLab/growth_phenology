...
(1) $g_{max}$ was $\ge 2.5$ standard deviations away from the mean for each xylem architecture (SCBI = 3, Harvard Forest = 11);  <!--run just by xylem architecture, or  by site-year-xylem architecture?-->
