...
In fact, we are aware of only a few studies that have documented stem-growth phenology of temperate deciduous forests over multiple years[@dorangeville_peak_2021; @etzold_number_2022; @tumajer_limitation_2022]. <!-- I'm not aware of any others, but we do want to make sure we're not missing anything. klesse_integrating_2016 and martin_hydrometeorology_2017 both do this, but for conifers.-->
**The climate sensitivity of woody growth phenology in temperate deciduous trees and its link to annual growth has never been studied *in-situ* (but see Ref.[@zohner_how_2021] for a controlled sapling experiment).** <!-- revise this statement. Etzold et al kind of do this.-->

Tree-ring records, which can be used to examine relationships of annual growth to temperature but not to understand growth phenology, reveal that growth of temperate deciduous trees tends to be most sensitive to temperature or potential evapotranspiration between late spring and early summer[@dorangeville_drought_2018;@helcoski_growing_2019]<!-- dorangeville_drought_2018 looks at PET.-->, with some hints that warmer springs may have a modest positive effect on growth[@helcoski_growing_2019].<!-- add more refs here, but only if already cited elsewhere (to keep n references down-->
...
We found a consistent effect of temperature ($T_{max}$ or $T_{min}$) throughout the spring, but the strongest effects on stem-growth phenology were found using $T_{max}$ during a critical temperature window (CTW). 
...
Our observations suggest that the cessation of rapid stem expansion, which occurs mid-summer near the time of peak canopy greenness (`r EDF_growth_curves_all`)[@finzi_carbon_2020; @etzold_number_2022], is likely driven by cues other than photosynthate limitation, such as daylength or sink limitation, which also play an important role in autumn leaf senescence[@zani_increased_2020;@keenan_timing_2015;@fu_variation_2014].
Our tree-ring analysis (Fig. `r tree_rings`) demonstrates that the primary effect of warming temperatures on annual tree growth is not an augmentation through an earlier start to growth, but rather a reduction associated to drought stress during the peak growing season[@dorangeville_drought_2018; @etzold_number_2022].
...
Our finding that interannual variation in woody growth is more strongly linked to conditions during the peak growing season than to growing season length aligns with *(Etzold)*[@etzold_number_2022] and with parallel findings for _NEE_[@zhou_explaining_2016; @fu_maximum_2019].
