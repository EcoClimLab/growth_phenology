...
Within the study period for the dendrometer band analysis (2011-2020), spring temperatures (March and April $T_{max}$; source: **local weather stations or CRU**, as described below) and summer Standardized Precipitation Evapotranspiration Index (SPEI)[@vicente-serrano_multiscalar_2010] values (4-month value of August) were similar to the average prior to the study period (1970-2010).
Specifically, average spring $T_{max}$ was 16.9°C prior to the study period (range: ) and 17.6°C (range: ) during the study period, while summer SPEI was -0.06 (range: ) prior to the study period and 0.51 (range: ) during.
...
Within the study period for the dendrometer band analysis (1999-2003), spring temperatures (March and April $T_{max}$; source: **local weather stations or CRU**, as described below) and summer SPEI values (4-month value of August) were similar to the average prior to the study period (1970-1998).
Specifically, average spring $T_{max}$ was 10.9°C prior to the study period (range: ) and 11.2°C (range: ) during the study period, while summer SPEI was 0.13 (range: ) prior to the study period and 0.20 (range: ) during.
