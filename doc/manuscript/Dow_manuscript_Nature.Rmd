...
Much less is known about deciduous tree responses[@savage_coordination_2021;@delpierre_temperate_2016].
...
However, earlier growth would not necessarily translate to earlier, faster, or more stem growth; rather, cell enlargement is dependent upon environmental conditions on hourly to daily time scales[@zweifel_why_2021], and annual growth is more closely linked to conditions within the growing season than to growing season length[@etzold_number_2022]. 
Furthermore, *growth of broadleaf deciduous trees may be sink-saturated*, such that longer growing seasons with more C fixation do not necessarily augment growth[@refs].
