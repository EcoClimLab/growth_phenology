...
We have little evidence as to how stem growth and $ANPP_{woody}$ respond to warmer spring temperatures, particularly for temperate deciduous forests. 
Most studies on tree growth responses to warmer spring temperatures have focused on boreal or temperate conifers, which tend to respond to warmer spring temperatures with an earlier start to growth[@conifer_refs] and increased annual growth in mesic climates[@gao_earlier_2022;@more_conifer_refs]. 
Much less is known about the climate sensitivity of growth of deciduous broadleaf trees, although it has been observed that their growth is more dependent on conditions within the growing season then on growing season length[@etzold_number_2022]. 
...
- start of xylogenesis makes growth possible, but actual growth depends on climate conditions during the growth period [@etzold_number_2022]
