...
We used packages *Rdendrom* (https://github.com/seanmcm/RDendrom/), *climwin* v.1.2.3 (https://cran.r-project.org/web/packages/climwin/index.html), *climpact* (see www.climpact-sci.org)[@benestad_empiricalstatistical_2008], *dplR* v.1.0.2, and *bootRes* v1.2.4. 
