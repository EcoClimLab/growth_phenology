...
The concept that stem growth is not enhanced under a longer growing season was supported by our tree-ring analysis, which showed that the effect of spring temperatures on tree growth is modest and not statistically significant for most species (Fig. `r tree_rings`, `r EDF_tree_rings_TMIN`).
...
Indeed, the tree-ring records reveal that annual growth is most commonly controlled by climate conditions during the peak growing season (Fig. `r tree_rings`).
...
These results align with other studies showing that while warmer spring temperatures can have a positive effect on annual growth for some species, most species show no significant response [@alexander_potential_2019; @helcoski_growing_2019].
These results align with @fu_maximum_2019, which shows that interannual variation in NEE is more strongly linked to peak C uptake rates than to growing season length. Our study demonstrates that this holds true for $ANPP_{woody}$ as well as NEE.
