...
5. Department of Geography & Geological Sciences, University of Idaho, ID, USA

6. Department of Geography, Indiana University, Bloomington, Indiana, USA
...
These findings align with findings that annual CO~2~ sequestration is more strongly linked to conditions in the peak growing season than to growing season length[@fu_maximum_2019], with observations that warm springs result in earlier leaf senescence[@zohner_ongoing_2019; @zani_increased_2020], and with evidence that forest CO~2~ sequestration is sink-limited[@zani_increased_2020].
...
Rather, our findings imply that *the extra CO~2~ sequestered in years with warmer springs[@keeling_increased_1996;@dragoni_evidence_2011;@crabbe_extreme_2016] is not allocated to the long-lived woody biomass C pool and is therefore unlikely to have a lasting impact on the forest C balance.*
...
To understand how annual growth increments have responded to spring temperatures at the centennial scale, we analyzed tree-ring chronologies from our focal study sites  (`r EDT_species`) and across an additional `r n_cores_sites-2` (Fig. `r tree_rings`, `r EDF_map`).
...
Metal dendrometer bands installed on a total of `r n_dendro_trees` trees within the SCBI and Harvard Forest ForestGEO plots (`r  EDT_species`). 
