...
The future behavior of this C sink will play an important yet uncertain role in influencing atmospheric CO~2~ and climate change[@arora_carbon_2020;@friedlingstein_global_2020]. 

~~~~ (new intro content starting here)
...
Based on these observations, current terrestrial ecosystem models effectively assume that longer growing seasons lead to sustained increases in annual net CO~2~ uptake (i.e., net ecosystem exchange, _NEE_)[@buermann_widespread_2018;@zani_increased_2020;@keenan_net_2014;@ahlstrom_robustness_2012].
#However, this assumption is overly simplistic given the known decoupling of photosynthate production and stem growth[@delpierre_temperate_2016;@delpierre_wood_2016], suggesting that model representaiton of C allocation to stem growth -- or woody aboveground net primary productivity ($ANPP_{woody}$) on the ecosystem level -- needs to be reworked.# 
However, model representation of C allocation to stem growth -- or woody aboveground net primary productivity ($ANPP_{woody}$) on the ecosystem level -- and its seasonality is simplistic relative to *known decoupling of photosynthate production and stem growth [@delpierre_temperate_2016;@delpierre_wood_2016]*. <!-- go back and check that these references are appropriate for this statement-->
Given that the C allocated to woody growth has the longest residence time in the ecosystem[@refs], understanding whether warming spring temperatures will lead to sustained increases in forest C sequestration requires understanding the sensitivity of $ANPP_{woody}$ to spring temperatures.
...
Most studies on tree growth responses to warmer spring temperatures have focused on boreal or temperate conifers, which tend to respond to warmer spring temperatures with an earlier start to growth[@huang_photoperiod_2020;@delpierre_chilling_2019;@rossi_critical_2008] and increased annual growth in mesic climates[@gao_earlier_2022;@anderson-teixeira_joint_2021; @more_conifer_refs]. 
Close coordination of budburst and initiation of xylogenesis[@delpierre_temperate_2016] suggests that warm springs should shift the onset of growth earlier in deciduous trees alongside observed advances in leaf phenology[@jeong_phenology_2011;@keenan_net_2014;@buermann_widespread_2018;@finzi_carbon_2020;@stuble_plant_2021;@delgado_differences_2020].
However, an earlier start to growth would not necessarily translate to greater or faster stem growth; instead, growth is dependent upon environmental conditions on hourly to daily time scales[@zweifel_why_2021] within the growing season rather than to growing season length[@etzold_number_2022]. 
Furthermore, *growth of broadleaf deciduous trees may be sink-saturated*, resulting in the lack of more C fixation to stem growth in extended growing seasons[@refs].
...
Characterizing responses of stem growth to warming spring temperatures is critical to bridging this conceptual disconnect and understanding how forest biomass growth is likely to change as the climate warms[@refs].
...
~~Tree-ring records, which can be used to examine relationships of annual growth to temperature[@gao_earlier_2022] but not to understand growth seasonality, reveal that growth of temperate deciduous trees tends to be most sensitive to temperature or potential evapotranspiration between late spring and early summer[@dorangeville_drought_2018;@helcoski_growing_2019]<!-- dorangeville_drought_2018 looks at PET.-->, with some hints that warmer springs may have a modest positive effect on growth[@helcoski_growing_2019].<!-- add more refs here, but only if already cited elsewhere (to keep n references down-->
