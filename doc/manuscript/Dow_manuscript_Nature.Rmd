...
This analysis was performed separately for ring- (69 trees at SCBI and 138 trees at Harvard Forest) and diffuse-porous (54 trees at SCBI and 202 trees at Harvard Forest) species, which differ in the seasonal timing of growth[@dorangeville_peak_2021; @tumajer_limitation_2022]. 
...
Seasonal milestones for both canopy foliage phenology and stem growth occurred 6-10 days earlier, on average, at SCBI than at Harvard Forest (Fig. `r DOY_timing`, `r  EDT_phenology_parameters`).
...
We ran separate models for each species group at each site, and for the response of all growth parameters to $T_{max}$ (or $T_{min}$). 
