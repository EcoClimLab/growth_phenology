...
**However, less is known about how spring temperatures affect tree stem growth[@huang_photoperiod_2020; @delpierre_chilling_2019; @rossi_critical_2008; @savage_coordination_2021], which sequesters carbon (C) in wood that has a long residence time in the ecosystem[@xue_global_2017;@russell_residence_2014].** <!--delpierre_chilling_2019, huang_photoperiod_2020, rossi_critical_2008, savage_coordination_2021 are for conifers!-->
...
However, recent experimental and observational findings show that annual stem growth is not correlated with growing season length[@etzold_number_2022], but rather can be limited by sink factors[@keenan_timing_2015; @zani_increased_2020; @zohner_how_2021; @delpierre_wood_2016],<!--I (KAT) want to work on this--> and that positive effects of warm springs can be compensated by negative effects of accumulation of seasonal water deficits[@buermann_widespread_2018]. 
