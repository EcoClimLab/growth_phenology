...
```{r pheno_Tsensitivity, out.width="80%", echo=FALSE, fig.align="center", fig.cap=DOY_Tsensitivity_caption}
# Created in RScripts/bert/wood_phenology_analysis_bert.R
knitr::include_graphics("tables_figures/DOY_Tsensitivity.png")
```
