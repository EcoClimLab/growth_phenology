...
This uncertainty has led to  a surge in recent studies documenting the climate sensitivity of stem growth timing and its link to annual growth[@dorangeville_peak_2021; @etzold_number_2022; @tumajer_limitation_2022; @zweifel_why_2021]. 
...
Our tree-ring analysis (Fig. `r tree_rings`) demonstrates that the primary effect of warming temperatures on annual ring-width is not an augmentation through an earlier start to growth, but rather a reduction associated to drought stress during the peak growing season[@dorangeville_drought_2018]. This decoupling between growing season length and annual growth mirrors results from another recent study by Etzold et al[@etzold_number_2022] which found that vapor pressure deficit plays a key role in limiting stem growth *- other studies which found VPD limits growth-*.
