...
However, this assumption is overly simplistic given the known decoupling of photosynthate production and stem growth[@delpierre_temperate_2016;@delpierre_wood_2016], suggesting that model representation of C allocation to stem growth -- or woody aboveground net primary productivity ($ANPP_{woody}$) on the ecosystem level -- needs to be reworked[@delpierre_temperate_2016]. 
