...
<!--LENGTH: The typical length of an article with 3-4 modest display items (figures and tables) is 2000-2500 words (summary paragraph plus body text). We're currently at 2644 words and 1 modest + 2 large display items. Articles typically have 30-50 references (currently at 53)-->
...
This adds to a growing body of evidence for a sink limitation of stem growth[@delpierre_wood_2016;@refs], wherein global change factors known to enhance photosynthesis, such as longer growing seasons or elevated CO~2~, do not cause a corresponding increase in stem growth[@jiang_fate_2020;@refs].
...
Thus, a positive effect of warm springs on the total C content of annual rings is unlikely, suggesting that warm springs do not augment $ANPP_{woody}$. 
