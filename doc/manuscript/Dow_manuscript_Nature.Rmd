...
**However, less is known about how spring temperatures affect tree stem growth, which sequesters carbon (C) in wood that has a long residence time in the ecosystem[@xue_global_2017;@russell_residence_2014].**
...
Current models assume that longer growing seasons lead to increasing annual net CO~2~ uptake (i.e., net ecosystem exchange, _NEE_)[@buermann_widespread_2018; @zani_increased_2020;@keenan_net_2014].
...
Our observations suggest that the cessation of rapid stem expansion, which occurs mid-summer near the time of peak canopy greenness (`r EDF_growth_curves_all`)[@finzi_carbon_2020], is likely driven by cues other than photosynthate limitation, such as daylength or sink limitation, which also play an important role in autumn leaf senescence[@zani_increased_2020;@keenan_timing_2015;@fu_variation_2014].
...
We show that the extra C fixation in years with warm springs does not substantially augment woody growth, but it remains unclear how it is allocated within the ecosystem.
...
Extra C could also be saved within trees as non-structural carbohydrates and used towards growth the following year[@trumbore_quantifying_2002;@richardson_seasonal_2013], potentially including an earlier start to growth[@fu_variation_2014]. 
