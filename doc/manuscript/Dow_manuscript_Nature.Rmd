...
Cameron Dow^1,11^ ( Orcid ID : 0000-0002-8365-598X)
...
5. Department of Earth and Spatial Sciences, University of Idaho, ID 83844, USA
...
11. Department of Forestry and Natural Resources, Purdue University, West Lafayette, Indiana, USA
...
However, recent experimental and observational findings show that annual productivity can be limited by sink factors[@keenan_timing_2015; @zani_increased_2020; @zohner_how_2021], and that positive effects of warm springs are compensated by negative effects of accumulation of seasonal water deficits[@buermann_widespread_2018]. These studies suggest that warmer spring temperatures may not have the expected positive effect on forest CO~2~ sequestration.

While some studies addressing the responses of leaf phenology and seasonal _NEE_ to warming spring temperatures exist[@jeong_phenology_2011; @keenan_net_2014; @buermann_widespread_2018; @ibanez_forecasting_2010; @menzel_european_2006; @menzel_growing_1999;@finzi_carbon_2020], little is known about how the longest-lived component of fixed C in trees, the woody growth, is responding to warming spring temperatures. 
