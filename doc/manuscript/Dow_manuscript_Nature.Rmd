...
<!--NOTE: We're probably pretty close to the upper length limit. The typical length of an article with 3-4 modest display items (figures and tables) is 2000-2500 words (summary paragraph plus body text). We're currently at 3005 words and 1 modest + 2 large display items. Articles typically have 30-50 references (currently at 59)-->
...
Most studies on tree growth responses to warmer spring temperatures have focused on boreal or temperate conifers, which tend to respond to warmer spring temperatures with an earlier start to growth[@huang_photoperiod_2020;@delpierre_chilling_2019;@rossi_critical_2008] and increased annual growth in mesic climates[@cook_predicting_1991;@babst_twentieth_2019;@anderson-teixeira_joint_2021; @gao_earlier_2022]. 
<!--In contrast, little is known about broadleaf deciduous tree responses[@savage_coordination_2021;@delpierre_temperate_2016].-->
...
<!--Seasonal milestones for both canopy foliage phenology and stem growth occurred 3-16 days earlier at SCBI than at Harvard Forest (Fig. `r DOY_timing`, `r  EDT_phenology_parameters`).--><!--cool to note, but is it necessary? Especially considering how broad "seasonal milestones for BOTH..." is.-->
...
The fate of any additional C fixed during years with warm springs remains unresolved, but possible *destinations* -- including respiration, NSC storage, and production of foliage, reproductive structures, roots[@zohner_how_2021], or root exudates -- generally have shorter residence times that woody growth.
In fact, in a situation where GPP was enhanced (through experimental elevation of CO~2~) but $ANPP_{woody}$ was constrained *(presumably by sink factors)*, additional C was released back to the atmosphere on relatively short time scales through enhanced respiration[@jiang_fate_2020].
Indeed, it has been observed that C loss through fall or winter respiration can offset gains from an earlier spring[@oishi_warmer_2018;@buermann_widespread_2018].
...
Across spatial gradients in spring temperature, warmer spring temperatures are associated with earlier leaf-out[@delgado_differences_2020] and longer growing seasons, which in turn are correlated with greater tree growth[@anderson-teixeira_joint_2021], woody productivity[@banburymorgan_global_2021], and NEE[@churkina_spatial_2005]<!--Can we replace this churkina_2005 ref with another NEE ref?-->.<!-- this sentence confuses me a bit. It seems like you're saying that warmer springs actually are associated wtih greater stem growth. Are you saying that warmer springs increase stem growth in some controlled studies, but that isn't being found in field conditions?  -->
Thus, warming spring temperatures are likely to increase the biophysical potential for annual tree growth, but that potential is not currently being realized on an interannual time frame.
...
Therefore, understanding how warming spring temperatures are influencing C allocation within temperate deciduous forest ecosystems remains an important outstanding question.
...
This finding is consistent with numerous tree-ring studies demonstrating strong sensitivity of growth to drought stress[@refs] or high temperatures[@refs] during the peak growing season.
...
<!--gao_earlier_2022 demonstrates the same for some other regions.-->
<!-- cite @gao_earlier_2022, noting that their result may be driven by conifers-->
<!--lessons learned from the more intense study of CO2 fertilization imply that stimulation of ANPP_woody is likely to be less than that of GPP-->
