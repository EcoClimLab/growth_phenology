...
We show that the extra C fixation in years with warm springs does not substantially augment stem growth in the current of following year (`r EDF_tree_rings_TMAX_extended`), but it remains unclear how it is allocated within the ecosystem.
...
It is theoretically possible that extra C is allocated to enhanced cell wall thickening, a process that lags behind stem expansion[@cuny_woody_2015], or to a thicker layer of higher-density latewood, resulting in formation of more C-dense wood in years with warm springs.
