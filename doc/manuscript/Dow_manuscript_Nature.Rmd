...
However, inconsistent with the concept that an earlier start to growth would increase annual woody productivity, we demonstrate that warmer springs hasten the cessation of stem expansion and thereby have negligible effect on total annual growth for most species and locations (Fig. `r tree_rings`). 
...
Our tree-ring analysis (Fig. `r tree_rings`) demonstrates that the primary effect of warming temperatures on annual tree growth is not an augmentation through an earlier start to growth, but rather a reduction associated to drought stress during the peak growing season[@dorangeville_drought_2018].
Warm springs may also amplify summer drought stress in some times and places, effectively canceling out any positive effects of an extended growing period[@buermann_widespread_2018;@zhang_drought_2021]; however, spring temperatures and summer Standardized Precipitation Evapotranspiration Index[@vicente-serrano_multiscalar_2010] were uncorrelated within our dendrometer band analysis, implying that the effects of warm spring temperatures on growth phenology elucidated here (Fig. `r schematic_summary`) were not attributable to summer drought. 
