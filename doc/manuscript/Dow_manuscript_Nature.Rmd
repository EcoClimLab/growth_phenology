...
CTW was identified by measuring the correlation between all combinations of weekly $T_{max}$ and $DOY_{25}$ from January 1 to mean $DOY_{25}$ for each xylem porosity-site combination (`r EDF_climwin`).
