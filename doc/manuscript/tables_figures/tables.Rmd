...
kable(species_table, caption = "Table 2. Dominant ring- and diffuse-porous species at SCBI and Harvard Forest, along with sample sizes analyzed here.",  format = "latex", booktabs = TRUE,  escape = F) %>%
