...
kable(summary_table, col.names = c("Variable", "Definition", "RP", "DP","RP", "DP"), format = "latex", booktabs = TRUE,  escape = F)%>%
  ...
  pack_rows("Daily growth rate", 5, 5, latex_gap_space = "1em", colnum = 4, hline_before = FALSE) %>%
...
```
*While this result was statistically significant, effect size was small (estimated change $\le 3$%/$^\circ$C) and considered not biologically significant
