...
ForestGEO is a global network of scientists and 71 forest plots dedicated to the long-term study of the world's forests. The ForestGEO plot at SCBI is a 26-ha forest located in Front Royal, Virginia. Every stem ≥1 cm is tagged, mapped, identified to species, and measured in diameter at breast height (DBH) every 5 years following standardized ForestGEO procedure (Condit, 1995). Within the plot, >500 trees have dendrometer bands which are measured at the start and end of each growing season, while a subset of ~150 are additionally measured every two weeks during the growing season. 
