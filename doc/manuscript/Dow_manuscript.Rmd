...
Specifically, $DOY_{25}$, $DOY_{50}$, $DOY_{75}$, and $DOY_{ip}$ all decreased significantly with increasing $T_{max}$ during the critical period (Table `r mean_growth_parameters_table`).
