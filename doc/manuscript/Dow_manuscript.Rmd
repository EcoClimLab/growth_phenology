...
*(Numbers in bold will change, updated; 11/18. Should be final results)*
...
At both sites, growth phenology differed between ring- and diffuse- porous species, with ring-porous species having an earlier start to growth, with growth spread out over a longer growing season (Fig. `r growth_curves_all`, Table `r mean_growth_parameters_table`).

For ring-porous trees, on average, 25% of annual growth was achieved on **May 4** ($DOY_{25}$=**123**) at SCBI and **May 15** ($DOY_{25}$=**132**) at Harvard FOrest, 50% on **June 2** ($DOY_{50}$=**152**) at SCBI and **June 9** ($DOY_{50}$=**159**) at Harvard Forest, and 75% on **June 30** ($DOY_{75}$=**180**) at SCBI and **July 6** ($DOY_{75}$=**186**) at Harvard Forest, for an average peak growing season length of **56** days at SCBI and **54** days at Harvard Forest. Maximum growth rate occurred *on $DOY_{50}$* at SCBI and *June 11* ($DOY_{max}$=**161**) at Harvard Forest and averaged .046 and .030 **mm day^-1^ (?)** respectively.

For diffuse-porous trees, on average, 25% of annual growth was achieved on **June 4** ($DOY_{25}$=**154**) at SCBI and **June 14** ($DOY_{25}$=**164**) at Harvard Forest, 50% on **June 22** ($DOY_{50}$=**172**) at SCBI and **July 2** ($DOY_{50}$=**182**) at Harvard Forest, and 75% on **July 10** ($DOY_{75}$=**190**) and **July 19** ($DOY_{75}$=**199**) at Harvard forest, for an average peak growing season length of **36** days at SCBI and **35** days at Harvard Forest. Maximum growth rate occurred *just one day after $DOY_{50}$* on **June 23** ($DOY_{max}$=**173**) at SCBI and **just one day after $DOY_{50}$** on **July 3** ($DOY_{max}$=**183**) at Harvard Forest and averaged .061 and .025 **mm day^-1^ (?)** respectively.
...
For the majority of weekly time windows from Jan. 1 to $DOY_{25}$, there was negative relationship between temperature and $DOY_{25}$, meaning that warmer temperatures shifted growth earlier in the season (Figs. `r climwin`, `r climwin_rp_DOY25_SCBI`, `r climwin_dp_DOY25_SCBI`). 
This held true for both ring- and diffuse-porous trees at both sites, *albeit* with stronger relationships for diffuse-porous trees. 
*(Describe the landscape:)*
In general, there were significant negative relationships between temperature and $DOY_{25}$ for any time period beginning $\ge$ **5** weeks prior to $DOY_{25}$, ending  $\le$ **8-20** weeks prior depending on wood-type and site, and covering at least a **3**-week period. 
...
Optimal windows occurred from **3/22-5/7** for ring-porous species and from **2/19-5/21** for diffuse-porous species.
...
At SCBI, ring-porous $DOY_{25}$ and $DOY_{50}$ shifted back while ${DOY_75}$ did not shift, resulting in an extended peak growing season length when critical window temperatures were warmer (Tables `r hypothesis_table`, Figs. `r pheno_Tsensitivity`, `r DOYtiming`).
Diffuse-porous $DOY_{25}$, $DOY_{50}$, and ${DOY_75}$ shifted back uniformly resulting in no significant change in peak growing season length. At Harvard Forest, ring-porous ${DOY_75}$ shifted back faster than ${DOY_25}$, resulting in shorter peak growins season length, while diffuse-porous ${DOY_25}$ shifted back faster than ${DOY_75}$, resulting in an extended peak growing season length in response to warmer critical window temperatures.  
...
Total annual growth, $\Delta DBH$, also was not consistently linked to early spring temperatures, displaying either no relationship (SCBI) or extremely small changes (Harvard Forest) (Tables `r hypothesis_table`, Fig. `r pheno_Tsensitivity`).
