...
(**Cameron, I'm not sure if the above text is up-to-date... ** )
...
*$DOY_{25}$ was generally less strongly correlated with $T_{min}$ than with $T_{max}$.-- not sure this is true*
(*give some details, cite SI tables.*)
