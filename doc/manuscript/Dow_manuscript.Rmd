...
The climate is humid temperate, with a mean annual precipitation of 998 mm and temperatures averaging 1° C in January and 24° C in July (Helcoski et al, 2019).  
...
Here, we tested for correlation between temperature ($T_{max}$, $T_{min}$) and $DOY_{25}$ over the time window from February 1 (Julian day = 32) and the mean $DOY_{25}$ for the species group and site (Table `r mean_growth_parameters_table`).
