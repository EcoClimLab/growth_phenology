...
25% of annual growth was achieved on **May 9** ($DOY_{25}$=**129**), 
50% on **June 6** ($DOY_{50}$=**157**), 
and 75% on **July 3** ($DOY_{75}$=**184**), 
for an average peak growing season length of **56** days. 
Maximum growth rate occurred *just one day after $DOY_{50}$* on **June 7** ($DOY_{max}$=**158**). 
At Harvard Forest,
25% of annual growth was achieved on **XX** ($DOY_{25}$=**XX**), 
50% on **XX** ($DOY_{50}$=**XX**), 
and 75% on **XX** ($DOY_{75}$=**XX**), 
for an average peak growing season length of **XX** days. 
Maximum growth rate occurred on **XX** ($DOY_{max}$=**XX**). 
...
Specifically, $DOY_{25}$, $DOY_{50}$, $DOY_{75}$, and $DOY_{g.max}$ all decreased significantly with increasing $T_{max}$ during the critical period (Table `r mean_growth_parameters_table`).
...
Because both $DOY_{25}$ and $DOY_{75}$ both shifted forward, peak growing season length was not consistently increased by warmer early spring temperatures (Tables `r hypothesis_table`, Figs. `r pheno_Tsensitivity`, `r DOYtiming`).
At both sites, $DOY_{75}-DOY_{25}$ decreased with temperature for ring-porous species 
and was neutral (SCBI) or positive (Harvard Forest) for diffuse-porous species.
...
In contrast, diffuse-porous species exhibited lower $g_{max}$ in years with higher early spring $T_{max}$.

Total annual growth rate, $\Delta DBH$, also was not consistently linked to early spring temperatures (Tables `r hypothesis_table`, Fig. `r pheno_Tsensitivity`).
