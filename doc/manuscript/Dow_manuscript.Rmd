...
As sink limitation controls the end of woody growing season [@zani_increased_2020], we might expect that an earlier start to growth buffers against unfavorable growth conditions during the peak growing season (e.g., drought).
